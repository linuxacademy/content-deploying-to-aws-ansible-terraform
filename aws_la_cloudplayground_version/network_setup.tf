...
#Create route in us-east-1 subnet for comms with peered VPC
resource "aws_route" "to_us-west-2-peered" {
  provider                  = aws.region-master
  route_table_id            = aws_route_table.internet_route.id
...
#Create route in us-west-2 subnet for comms with peered VPC
resource "aws_route" "to_us-east-1-peered" {
  provider                  = aws.region-worker
  route_table_id            = aws_route_table.internet_route_oregon.id
